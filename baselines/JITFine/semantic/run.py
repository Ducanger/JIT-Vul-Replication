...
from baselines.JITFine.semantic.model import Model
from baselines.JITFine.my_util import convert_examples_to_features, TextDataset, eval_result, create_path_if_not_exist
...
def main():
    ...
    # Training
    if args.do_train:
        print("Creating features from index file at %s ", args.train_data_file)
        cache_dataset = os.path.join(os.path.dirname(args.test_data_file[0]),
